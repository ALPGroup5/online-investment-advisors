...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server" EnableViewState="false">
    <table width=100% >
    <tr><th><asp:Image ID="Image4" runat="server" ImageUrl="~/img/str/buttons/NPS.bmp" /></th>
    <th><asp:Image ID="Image3" runat="server" ImageUrl="~/img/str/buttons/FD.bmp" /></th>
    <th><asp:Image ID="Image2" runat="server" ImageUrl="~/img/str/buttons/PPF.bmp" /></th></tr>
    <tr><td><%--<asp:Image ID="Image4" runat="server" ImageUrl="~/img/str/buttons/lap.bmp" />--%>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:shopingConnectionString1 %>"
            ...
            <SelectParameters>
                <asp:Parameter DefaultValue="NPS" Name="catagory" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <asp:Label ID="Label3" runat="server"></asp:Label>
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/laptop.aspx" BackColor="#BBFFFF">CLICK TO SEE ALL NPS</asp:HyperLink>
    </td>
    <!-- pnel 2 start here -->
   <td><%--<asp:Image ID="Image3" runat="server" ImageUrl="~/img/str/buttons/car.bmp" />--%>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:shopingConnectionString1 %>"
            SelectCommand="SELECT top 3 id,upper(productName) as p,productName,upper(brand) as b,image FROM [product] WHERE ([catagory] = @catagory)">
            <SelectParameters>
                <asp:Parameter DefaultValue="FD" Name="catagory" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/car.aspx" BackColor="#BBFFFF">CLICK TO SEE ALL FD's</asp:HyperLink>
    </td>
    <td><%--<asp:Image ID="Image2" runat="server" ImageUrl="~/img/str/buttons/mob.bmp" />--%>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:shopingConnectionString1 %>"
            SelectCommand="SELECT top 3 id,upper(productName) as p,productName,upper(brand) as b,image FROM [product] WHERE ([catagory] = @catagory)">
            <SelectParameters>
                <asp:Parameter DefaultValue="PPF" Name="catagory" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="~/mobile.aspx" BackColor="#BBFFFF">CLICK TO SEE ALL PPF</asp:HyperLink>
        <br />
    </td>
    </tr></table>
</asp:Content>
